...
public class Login extends BaseTest {
	...
	public void login() throws InterruptedException {
		...
		WebElement drama = wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.accessibilityId("Drama")));
		drama.click();

		WebElement elementcheck = wait
		...
		WebElement clickonsendotp = wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//android.view.View[@content-desc='Send OTP']")));
		clickonsendotp.click();

		System.out.println("Application login successful");

		// enter OTP
		WebElement clickonelement = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.EditText")));
	...
	public void ValidatewrongNumber() throws InterruptedException {
		...
		WebElement elementcheck = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.EditText")));
		elementcheck.click();
		elementcheck.sendKeys("9634420847");
		...
		@Nullable
		WebElement elementisvisible = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.ScrollView")));

		if (elementisvisible.isDisplayed()) {
			System.out.println("If using wrong Number so not login");
		} else {
